(function (global, factory) {
  ...
  class MetaTree {
    ...
    authenticate(token) {
      ...
      const certified = this._claimCertification();
    ...
    _claimCertification() {
      return new Promise((resolve, reject) => {
        this._auth.claimants.push({resolve, reject});
      });
    }

    _settleCertification(promise) {
      const claimant = this._auth.claimants.shift();
      if (claimant) promise.then(claimant.resolve, claimant.reject);
    }
